...
export class MeetingApi {
  ...
  tempsave(json, callback, showLoading = true) {
    ...
    console.log(header);
    wx.request({
      url: ApiConfig.GetApiUrl() + 'meeting/tempsave',
      data: json,
      method: 'POST',
      dataType: 'json',
      header: header,
  ...
  complete(json, callback, showLoading = true) {
    ...
    console.log(header);
    wx.request({
      url: ApiConfig.GetApiUrl() + 'meeting/complete',
      data: json,
      method: 'POST',
      dataType: 'json',
      header: header,
